  ...
  public content: CommentInterface[] = [
    {
      ...
      title: 'Шевчук Назар',
      description:
        'Найращі рецепти, дуже просто та смачно, дякую. Рекомендую брати все меню, бо краще всі разом взяти та заощадити кошти',
    },
    {
      img: 'assets/images/comment6.svg',
      title: 'Соловський Сергій',
      description:
        'Відповідають оперативно, зразу після оплати скинули рецепти, заощадила час та кошти.',
    },
    {
      img: 'assets/images/comment4.svg',
      title: 'Кичко Ніна',
      description:
        'Смачнота цих страв перевищує всі мої очікування, шедевр дякую.',
    },
    {
      img: 'assets/images/comment7.svg',
      title: 'Сілінченко Марина',
      description:
        'Якщо б могла їсти цю страву кожен день, я була б найщасливішою людиною на світі!',
    },
    {
    ...
    },
    {
      ...
      title: 'Гурська Аліна',
      description:
        'Спробувавши ці страви, я буквально закохався в її смак - це просто диво кулінарії!.',
    },
  ];
}
